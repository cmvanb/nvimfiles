...
hi('NonText',                   { fg = 'editor_nontext' },                                             { fg = 'ansi_brwhite' })
...
hi('Statement',          { fg = 'syn_keyword', attrs = 'bold' },                       { fg = 'ansi_brgreen', attrs = 'bold' })
...
hi('Special',            { fg = 'syn_special', attrs = 'bold' },                       { fg = 'ansi_yellow' })
hi('SpecialText',        { fg = 'yellow_7', attrs = 'bold' },                          { fg = 'ansi_brblack' })
hi('Underlined',         { fg = 'web_link', attrs = 'underline' },                     { fg = 'ansi_blue' })
hi('Delimiter',          { fg = 'syn_delimiter' },                                     { fg = 'ansi_green' })
hi('String',             { fg = 'syn_string' },                                        { fg = 'ansi_yellow' })
hi('Keyword',            { fg = 'syn_keyword', attrs = 'bold' },                       { fg = 'ansi_brgreen', attrs = 'bold' })
hi('Function',           { fg = 'syn_function', attrs = 'bold' },                      { fg = 'ansi_brcyan', attrs = 'bold' })
hi('Number',             { fg = 'syn_number' },                                        { fg = 'ansi_brred' })
hi('Boolean',            { fg = 'syn_boolean' },                                       { fg = 'ansi_red' })
...
hi('@markup.heading.1',  { fg = 'heading_1', attrs = 'bold' },                         { fg = 'ansi_brwhite' })
hi('@markup.heading.2',  { fg = 'heading_2', attrs = 'bold' },                         { fg = 'ansi_brwhite' })
hi('@markup.heading.3',  { fg = 'heading_3', attrs = 'bold' },                         { fg = 'ansi_white' })
hi('@markup.heading.4',  { fg = 'heading_4', attrs = 'bold' },                         { fg = 'ansi_white' })
hi('@markup.heading.5',  { fg = 'heading_5', attrs = 'bold' },                         { fg = 'ansi_brblack' })
hi('@markup.heading.6',  { fg = 'heading_6', attrs = 'bold' },                         { fg = 'ansi_brblack' })
