...
hi('IlluminatedWordRead',    { bg = 'primary_3' },                                     { fg = 'ansi_brblack', bg = 'ansi_white', attrs = 'bold' })
hi('IlluminatedWordText',    { bg = 'primary_3' },                                     { fg = 'ansi_brblack', bg = 'ansi_white', attrs = 'bold' })
hi('IlluminatedWordWrite',   { bg = 'primary_3' },                                     { fg = 'ansi_brblack', bg = 'ansi_white', attrs = 'bold' })
