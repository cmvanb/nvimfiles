...
hi('Visual',                    { fg = 'black', bg = 'primary_12' },                     { fg = 'ansi_white', bg = 'ansi_blue' })
hi('IncSearch',                 { fg = 'black', bg = 'green_4', attrs = 'bold' },        { fg = 'ansi_black', bg = 'ansi_green' })
hi('Search',                    { fg = 'black', bg = 'primary_12', attrs = 'bold' },     { fg = 'ansi_black', bg = 'ansi_blue', attrs = 'none' })
hi('CurSearch',                 { fg = 'black', bg = 'green_4', attrs = 'bold' },        { fg = 'ansi_black', bg = 'ansi_green', attrs = 'none' })
...
hi('FloatMenuSelection',    { fg = 'text_15', bg = 'primary_8', attrs = 'bold' },  { fg = 'ansi_brwhite', bg = 'ansi_black', attrs = 'bold' })
